...
public class RomanNumeralService implements IRomanNumeralService {
    ...
    /**
     * This method accepts an integer number and returns a RomanNumeral
    ...
    public RomanNumeral convertDecimalToRomanNumeral(final int number) {
        ...
        // We loop through the values which are arranged in a descending order
        // and keep subtracting the values from the number and appending the
